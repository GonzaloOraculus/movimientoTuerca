...
namespace OVRTouchSample
{
    ...
    [RequireComponent(typeof(OwnGrabber))]

    public class OwnHand : MonoBehaviour
    {
        ...
        /*********************************************************
         * Variables añadidas para forzar la apertura de mano
         ********************************************************/
        private bool forceOpen;
        [SerializeField]
        private float forceOpenTime;
        private float openCurrentTime;

        /*********************************************************
         * Metodo añadido para la apertura de mano
         * ******************************************************/
