...
public class OwnGrabber : MonoBehaviour
{
    ...
    /***********************************************************************/
    //Se elimina para simplificar pues m_parentHeldObject siempre será true
    //[SerializeField]
    ...
    /**************************************************************************
     * Se elimina para simplificar pues m_moveHandPosition será false siempre
    [SerializeField]
    ...
    ***************************************************************************/
    ...
    protected virtual void Awake()
    {
        ...
        //por lo tanto la posición local corresponde con la posición del anchor de la mano
    ...
    protected virtual void Start()
    {
        ...
        /*********************************************************************************
         * Se modifica pues m_parentTransform siempre será null
    ...
    void OnUpdatedAnchors()
    {
         ...
         *m_moveHandPosition siempre será false
         *m_parentHeldObject siempre será true
         *
         *Finalmente cada setup se actualiza la posición de m_lstPos y m_lastRot y se verifica si se soltó el objeto
         *
         *
    ...
    protected virtual void GrabBegin()
    {
        ...
        {
            /****************************************************************************
             * Este if nunca se ejecutará pues allowOffhandGrab siempre será true
             * *************************************************************************
            ...
            ******************************************************************************/
            ...
            /**********************************************************
             * Solo se tendrá un grabpoint por grabbable, no es necesario el for
             * ********************************************************
        ...
        if (closestGrabbable != null)
        {
            ...
            m_grabbedObj = closestGrabbable;   //Es el script OwnGrabbable del grabbable más cercano
            m_grabbedObj.GrabBegin(this, closestGrabbableCollider); //Se indica al grabbable quien y por donde lo están agarrando
            ...
            *********************************************************/
            ...
            /*******************************************************************************
             * Se mueve esta sentencia para juntarla con la otra que necesita saber si el objeto está encajado
